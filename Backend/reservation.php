        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="reservation.php" class="active"> <i class="bi bi-circle"></i><span>Reservation</span>
                        </a>
                    </li>
                    <li>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table class="table">
                                ...
                                <?php $i = 1; ?>
                                <?php
                                $result = "SELECT * FROM reservation ";
                                ...
                                <tr>
                                    ...
                                    <td data-id="<?php echo $row['id']; ?>"><?php echo $row['time']; ?></td>
                                    <td data-id="<?php echo $row['id']; ?>"><?php echo $row['people']; ?></td>
